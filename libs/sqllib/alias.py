...
def num_aliases_under_domains(conn, domains, disabled_only=False, first_char=None):
    ...
    if first_char:
        sql_where += ' AND alias LIKE %s' % web.sqlquote(first_char.lower() + '%')
